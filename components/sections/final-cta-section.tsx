...
export function FinalCtaSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-ink py-24 text-canvas sm:py-32">
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_bottom_left,_rgba(168,80,59,0.35)_0%,_transparent_60%)]"
      />
      <div className="mx-auto max-w-3xl px-6 text-center sm:px-8">
        <Reveal>
          ...
          <p className="mx-auto mt-5 max-w-md text-balance text-base leading-relaxed text-canvas/75">
            ...
            starting with a single conversation.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.15} className="mt-9 flex flex-wrap items-center justify-center gap-4">
          <a
            href="#coaching"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-canvas px-6 py-3 text-sm font-medium tracking-wide text-ink transition-colors duration-200 hover:bg-highlight"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-full border border-canvas/30 px-6 py-3 text-sm font-medium tracking-wide text-canvas transition-colors duration-200 hover:bg-canvas hover:text-ink"
          >
            Chat on WhatsApp
          </a>
        </Reveal>
